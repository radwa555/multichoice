...
class qtype_multichoiceset_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        //--------------- adding element and defualt value 0   ---------------------
        
        
        $mform->addElement('text', 'minusmarks', 'minus marks');
        $mform->setDefault('minusmarks', 0);
    ...
    protected function data_preprocessing($question) {
        ...
        if (!empty($question->options)) {
           ...
           //------------------ get previous data on edit ---------------
            $question->minusmarks = $question->options->minusmarks;
            //---------------------------------
